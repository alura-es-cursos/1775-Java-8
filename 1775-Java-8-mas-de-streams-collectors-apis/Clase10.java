...
public class Clase10 {
    ...
    public static void main(String[] args) {
        ...
        cursosTipos.add(new CursoTipo("curso de fisica", 200, 1));
        cursosTipos.add(new CursoTipo("curso de java 8", 500, 1));
        cursosTipos.add(new CursoTipo("curso de geometria del espacio", 400, 2));
        ...
        Map<Integer, List<CursoTipo>> mapaCursosTipos = cursosTipos.stream().filter(x-> x.getHoras()>100)
